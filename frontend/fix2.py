...
# Wait, let's find end_idx accurately:
end_pattern = re.compile(r'</div>\s*</div>\s*</div>\s*</div>\s*</motion\.div>')
...
if start_idx != -1 and end_match:
    ...
    print("WARNING: Could not find start_idx or end_match for buttons.")
